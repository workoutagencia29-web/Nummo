      ...
      <main id="conteudo" className="mx-auto max-w-4xl px-6 py-20 md:py-28">
        <div className="lg:-ml-24 xl:-ml-40">
          ...
          <p className="mt-3 text-muted-foreground">
            Acompanhe, em tempo real, a disponibilidade e o desempenho de todos os serviços da Nummo
            — API, Checkout, Links de Pagamento, PIX, cartões, boleto, dashboard e saques.
            Transparência total para você operar com segurança e previsibilidade.
          </p>
        </div>
        ...
        <div className="mt-14 lg:mt-[98px] lg:-ml-12 lg:-mr-16 xl:-ml-24 xl:-mr-28">
          ...
          {/* Serviços */}
          <h2 className="mb-4 mt-14 font-mono text-[11px] uppercase tracking-widest text-muted-foreground">
            Serviços
          </h2>
  ...
  head: () => ({
    meta: [
      { title: "Status — Nummo" },
      {
        name: "description",
        content:
          "Status em tempo real dos serviços da Nummo — API, Pix, cartões, boleto, dashboard e saques.",
      },
