      ...
      <main id="conteudo">
        ...
        <div className="mx-auto max-w-4xl px-6 pt-20 md:pt-28">
          <div className="lg:-ml-24 xl:-ml-40">
            <div className="mb-5 font-mono text-xs uppercase tracking-[0.3em] text-[#0D1B39]">/ E-mail</div>
        ...
        <div className="mx-auto max-w-4xl px-6 pb-20 md:pb-28">
          <div className="mt-14 text-pretty text-lg leading-relaxed text-muted-foreground lg:-ml-12 lg:-mr-16 lg:mt-[98px] xl:-ml-24 xl:-mr-28 [&>*:first-child]:mt-0">
            ...
            <div className="mt-8">
              <div className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">Escreva para</div>
              <a
            ...
            <p className="mt-12">
              <strong className="font-medium text-foreground">Tempo de resposta:</strong> respondemos em até 24 horas úteis. Casos urgentes envolvendo pagamentos têm prioridade.
            </p>
            <p className="mt-5">
              <strong className="font-medium text-foreground">Pra agilizar,</strong> inclua no e-mail: o CNPJ da sua conta, o e-mail cadastrado e uma breve descrição do que está acontecendo (prints ajudam muito).
            </p>
            <p className="mt-5">
              <strong className="font-medium text-foreground">Atendimento:</strong> segunda a sexta, das 9h às 18h (horário de Brasília).
            </p>
          </div>
        </div>
      </main>
