...
/* Fundo de gradiente animado (WebGL / simplex-noise). Ajustes de performance:
...
const Velaris = ({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      if (raf == null) draw(lastT); // redesenha o quadro estático quando pausado
    };
    ...
    // 1 quadro estático garantido; loop só quando visível e sem reduced-motion.
    draw(0);
