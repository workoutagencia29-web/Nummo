      ...
      <main id="conteudo">
        ...
        <div className="mx-auto max-w-4xl px-6 pt-20 md:pt-28">
          <div className="lg:-ml-24 xl:-ml-40">
            ...
            <h1 className="text-balance font-display text-4xl font-medium leading-[1.05] tracking-tight md:text-6xl">Novidades</h1>
            <p className="mt-3 text-muted-foreground lg:-mr-16 xl:-mr-44">Acompanhe tudo o que estamos construindo, lançando e aprimorando na Nummo. Aqui você encontra novas funcionalidades, melhorias de performance, atualizações de segurança, integrações e evoluções feitas para deixar sua operação cada vez mais rápida, estável e eficiente.</p>
          </div>
        </div>
