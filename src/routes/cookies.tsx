        ...
        <div className="mx-auto max-w-4xl px-6 pt-20 md:pt-28">
          <div className="lg:-ml-24 xl:-ml-40">
            ...
            <h1 className="text-balance font-display text-4xl font-medium leading-[1.05] tracking-tight md:text-6xl">
              Cookies do site da Nummo
            </h1>
            <p className="mt-3 text-muted-foreground">
              Entenda quais cookies a Nummo utiliza, para que servem e como você pode aceitar,
              recusar ou gerenciar cada um deles a qualquer momento — com total controle e
              transparência.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6 pb-20 md:pb-28">
          <div className="mt-14 text-pretty text-lg leading-relaxed text-muted-foreground lg:-ml-12 lg:-mr-16 lg:mt-[98px] xl:-ml-24 xl:-mr-28 [&>*:first-child]:mt-0">
            ...
            <p className="mt-6 text-xl text-foreground/90">
              A Nummo utiliza cookies, pixels, trackers e tecnologias semelhantes para garantir o
              funcionamento do site, melhorar sua experiência, entender como os visitantes utilizam
              nossos ambientes digitais e medir campanhas de marketing.
            </p>
            <p className="mt-5">
            ...
            <p className="mt-1.5">
              Essenciais para o funcionamento do site, segurança, carregamento de páginas,
              preferências básicas e prevenção a fraudes. Esses cookies não podem ser desativados
              sem comprometer certas funcionalidades.
            </p>

            <p className="mt-6 font-medium text-foreground">Cookies de desempenho e analytics</p>
            <p className="mt-1.5">
              Nos ajudam a entender como o site é utilizado, identificar páginas mais acessadas,
              medir desempenho e corrigir eventuais falhas.
            </p>

            <p className="mt-6 font-medium text-foreground">Cookies de marketing e campanhas</p>
            <p className="mt-1.5">
              Podem ser utilizados para mensurar campanhas, identificar a origem de acessos, criar
              públicos de remarketing e apresentar comunicações mais relevantes em plataformas de
              mídia.
            </p>
            ...
            <p className="mt-6">
              Você poderá aceitar, recusar ou configurar cookies não essenciais por meio do banner
              de cookies disponibilizado no site.
            </p>
            <p className="mt-5">
              Também é possível gerenciar cookies diretamente nas configurações do seu navegador. A
              desativação de cookies necessários pode afetar o funcionamento de algumas áreas do
              site e da Plataforma.
            </p>
            <p className="mt-5">
  ...
  head: () => ({
    meta: [
      { title: "Cookies — Nummo" },
      {
        name: "description",
        content:
          "Política de Cookies da Nummo: quais cookies usamos (necessários, analytics e marketing) e como você pode gerenciá-los.",
      },
