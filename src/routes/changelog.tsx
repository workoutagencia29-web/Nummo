      ...
      <main id="conteudo">
        ...
        <div className="mx-auto max-w-4xl px-6 pt-20 md:pt-28">
          <div className="lg:-ml-24 xl:-ml-40">
            ...
            <p className="mt-3 text-muted-foreground lg:-mr-16 xl:-mr-44">
              Acompanhe tudo o que estamos construindo, lançando e aprimorando na Nummo. Aqui você
              encontra novas funcionalidades, melhorias de performance, atualizações de segurança,
              integrações e evoluções feitas para deixar sua operação cada vez mais rápida, estável
              e eficiente.
            </p>
          </div>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Changelog — Nummo" },
      {
        ...
        content: "Novidades, melhorias e correções da plataforma Nummo.",
      },
